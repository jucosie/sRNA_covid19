...
perl /storage/ncRNA/Softwares/unitas_1.8.0.pl -input ${input_dir} -species homo_sapiens -trim AGATCGGAAGAG -skip_dust off -trim_minlength 12 -trim_maxlength 34 -keep_temp -species_miR_only -na_for_phasi -tail 0 -insdel 1
