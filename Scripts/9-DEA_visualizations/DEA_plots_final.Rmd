---
title: "Differential Exoression Analysis plots"
...
write.table(T1_acute_summary[,-3], "/home/ultramind/Disco2/SARS_sRNA_paper/Results/09-Exogenous_sRNAs_analysis/T1_severe_summary.tsv", sep="\t", row.names=FALSE)
write.table(T2_acute_summary[,-3], "/home/ultramind/Disco2/SARS_sRNA_paper/Results/09-Exogenous_sRNAs_analysis/T2_severe_summary.tsv", sep="\t", row.names=FALSE)
write.table(T1_mild_summary[,-3], "/home/ultramind/Disco2/SARS_sRNA_paper/Results/09-Exogenous_sRNAs_analysis/T1_moderate_summary.tsv", sep="\t", row.names=FALSE)
write.table(T2_mild_summary[,-3], "/home/ultramind/Disco2/SARS_sRNA_paper/Results/09-Exogenous_sRNAs_analysis/T2_moderate_summary.tsv", sep="\t", row.names=FALSE)
